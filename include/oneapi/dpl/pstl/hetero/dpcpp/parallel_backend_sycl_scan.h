               ...
               _BinaryOp __binary_op)
{
    ...
    {
        using KernelParamsLarge = oneapi::dpl::experimental::kt::kernel_param<16, 128, class LargeScanKernel>;
        return oneapi::dpl::experimental::kt::single_pass_inclusive_scan<KernelParamsLarge>(__queue, __in_begin, __in_end,
                                                                                            __out_begin, __binary_op);
    }
}
